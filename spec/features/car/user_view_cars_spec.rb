...
feature 'User view cars' do
  scenario 'successfully' do
    ...
    other_car_model = CarModel.create!(name: 'Punto', year: '2019', manufacturer: manufacturer, motorization: '1.8', car_category: car_category, fuel_type: 'Gasolina')
    subsidiary = Subsidiary.create!(name: 'Filial Santos', cnpj: '37645468000143', address: 'Rua dos Santos, 13')
    other_subsidiary = Subsidiary.create!(name: 'Filial Osasco', cnpj: '70976813000105', address: 'Rua de Osasco, 14')
    Car.create!(license_plate: 'ABC-1234', color: 'Prata', car_model: car_model, mileage: '180', subsidiary: subsidiary, status: 0)
    Car.create!(license_plate: 'DEF-5678', color: 'Branco', car_model: other_car_model, mileage: '40', subsidiary: other_subsidiary, status: 5)
