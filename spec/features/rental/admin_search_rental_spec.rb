...
feature 'Admin search rental' do
  scenario 'by partial query' do
    ...
    car_model = create(:car_model, name: 'Palio', motorization: '1.6', year: '2020', fuel_type: 'Gasolina', car_category: car_category, manufacturer_id: manufacturer.id)
    create(:car, license_plate: 'ABC-1234', color: 'Vermelho', car_model: car_model, mileage: 0, status: 0, subsidiary: subsidiary)
