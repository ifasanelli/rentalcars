...
feature 'User starts rental' do
    scenario 'successfully' do
        ...
        Client.create!(name: 'Mariana', cpf: '123.456.789-10', email: 'mari@gmail.com')
        ...
        CarModel.create!(name: 'Palio', motorization: '1.6', year: '2020', fuel_type: 'Gasolina', car_category_id: car_category.id, manufacturer_id: manufacturer.id)
        Car.create!(license_plate: 'ABC-1234', color: 'Vermelho', car_model_id: car_category.id, mileage: 0, status: 0, subsidiary_id: subsidiary.id)
        Car.create!(license_plate: 'AAA-4321', color: 'Roxo', car_model_id: car_category.id, mileage: 0, status: 0, subsidiary_id: subsidiary.id)
