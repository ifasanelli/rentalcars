...
describe 'Car Menagement' do
    context 'show' do
        it 'renders a json succssfully' do
            ...
            car_model = CarModel.create!(name: 'X5', 
                                         year: '2019', 
                                         motorization: '1.6',
                                         fuel_type: 'Flex', 
                                         manufacturer_id: 1, 
                                         car_category_id: 1)
            car = Car.create!(license_plate: 'ABC-1212', 
                              color: 'Branco', 
                              car_model: car_model, 
                              mileage: 155, 
    ...
    context 'index' do
        it 'renders a json succssfully' do
            ...
            other_car_model = CarModel.create!(name: 'X3', 
                                        year: '2017', 
                                        motorization: '2.6',
                                        fuel_type: 'Gasolina', 
                                        manufacturer: manufacturer, 
                                        car_category: car_category)
            car = Car.create!(license_plate: 'ABC-1313', 
                              color: 'Prata', 
                              car_model: car_model, 
                              mileage: 65, 
                              subsidiary: subsidiary, 
                              status: 0)
            other_car = Car.create!(license_plate: 'ABC-1212', 
                                    color: 'Branco', 
                                    car_model: other_car_model, 
                                    mileage: 180, 
                                    subsidiary: subsidiary, 
                                    status: 0)
            another_car = Car.create!(license_plate: 'ABC-1212', 
                                      color: 'Branco', 
                                      car_model: car_model, 
                                      mileage: 155, 
                                      subsidiary: subsidiary, 
  ...
  context 'create' do
    it 'should create a car' do
        ...
        car = Car.create!(license_plate: 'ABC-1212', 
            ...
            post  api_v1_cars_path(), params: {license_plate: car.license_plate, 
                                            color: car.color, 
